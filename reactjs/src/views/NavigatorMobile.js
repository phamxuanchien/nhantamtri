...
class NavigatorMobile extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                <ul className="navigator-mobile-menu list-unstyled">
                    {
...
export default withRouterInnerRef(connect(mapStateToProps, mapDispatchToProps)(NavigatorMobile));
