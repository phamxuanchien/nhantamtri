...
import './ManageProjectneedhelp.scss';
import MarkdownIt from 'markdown-it';
import MdEditor from 'react-markdown-editor-lite';
import { LANGUAGES, CommonUtils } from '../../../utils';
import { createNewProjectneedhelp } from '../../../services/userService';
import { toast } from "react-toastify";
import * as actions from "../../../store/actions";

const mdParser = new MarkdownIt();
class ManageProjectneedhelp extends Component {
    constructor(props) {
        super(props);
        this.state = {
            name: '',
    ...
    handleSaveNewProjectneedhelp = async () => {
        let res = await createNewProjectneedhelp(this.state)
        if (res && res.errCode === 0) {
            toast.success('Add new projectneedhelp succeeds!')
            this.setState({
                name: '',
                address: '',
                location: '',
    ...
    render() {
        ...
        return (
            ...
            <div className="manage-projectneedhelp-container">
                <div className="ms-title">Quản lý dự án cần giúp đỡ</div>
                <div className="add-new-projectneedhelp row">
                    <label className="add-new">Tạo dự án mới</label>
                    <div className="col-12 projectneedhelp-info">
                        <label className="project-info">Thông tin về dự án</label>
                        <div className="element col-12">
                            ...
                            <div className="col-6 form-group">
                                <label>Dự án cần giúp này thuộc chương trình</label>
                        ...
                        <div className="element col-12">
                            <div className="col-12 form-group">
                                <label>Địa điểm thực hiện dự án</label>
                        ...
                        <div className="element col-12">
                            <div className="col-6 form-group">
                                <label>Mục đích của dự án</label>
                        ...
                        <div className="element col-12">
                            ...
                            <div className="col-6 form-group">
                                <label>Dự kiến thời gian đi vào hoạt động</label>
                        ...
                        <div className="element col-12">
                            <div className="col-6 form-group">
                                <label>Dự án đang trong giai đoạn</label>
                                <select className="form-control"
                            ...
                            <div className="col-6 form-group">
                                <label>Hình ảnh của dự án</label>
                    ...
                    <div className="col-12 projectneedhelp-contact">
                    ...
                    <label className="project-content">Thêm nội dung của dự án</label>
                    ...
                    <div className="col-12">
                        <button className="btn-save-projectneedhelp"
                            onClick={() => this.handleSaveNewProjectneedhelp()}
                        >Save</button>
                    </div>
                </div>
            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageProjectneedhelp);
